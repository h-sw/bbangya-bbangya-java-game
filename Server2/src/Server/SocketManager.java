...
public class SocketManager extends Thread implements Runnable,Serializable{
	private int cnt = 0;
	...
	public SocketManager(Socket socket, ServerManager parent) {
		...
		while (isConnected) {
			try {
				...
				if (requestPacket.getMethodName().equals("sendXY")) {
					...
					game.updatePlayer(this,(String) args[0], (int) args[1], (int) args[2], (int) args[3],(boolean)args[4],(int)args[5]);
